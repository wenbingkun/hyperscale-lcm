...
require_regex '\./gradlew (build -Dquarkus\.package\.type=fast-jar -x test|quarkusBuild -Dquarkus\.package\.type=fast-jar --no-daemon)' "load-test must build core as fast-jar"
