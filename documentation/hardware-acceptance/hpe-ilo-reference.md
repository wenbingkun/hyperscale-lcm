# HPE iLO Reference Acceptance Template

> Sample / template entry. Replace with a real verification once the HPE iLO lab rig is wired up.
...
| Model | iLO (TBD) |
| BMC Firmware | TBD |
| Network Path | https://hpe-ilo-lab.example/redfish/v1 |
| Owner | TBD |
| Last Verified | TBD |
...
- `satellite/pkg/redfish/testdata/vendor-fixtures/hpe-ilo.json` — current HPE iLO baseline used by Satellite fixture regression.
